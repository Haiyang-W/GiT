...
@TRANSFORMS.register_module()
class SegLoadImageFromNDArray(LoadImageFromFile):
...
@TRANSFORMS.register_module()
class SegLoadBiomedicalImageFromFile(BaseTransform):
...
@TRANSFORMS.register_module()
class SegLoadBiomedicalAnnotation(BaseTransform):
...
@TRANSFORMS.register_module()
class SegLoadBiomedicalData(BaseTransform):
...
@TRANSFORMS.register_module()
class SegInferencerLoader(BaseTransform):
    """Load an image from ``results['img']``.
