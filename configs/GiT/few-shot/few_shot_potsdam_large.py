...
train_dataloader = dict(
    ...
    dataset=dict(
                ...
                support_num=5*6,
                return_classes=True,
                pipeline=potsdam_semseg_train_pipeline) 
    )
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=potsdam_semseg_test_pipeline))
test_pipeline = potsdam_semseg_test_pipeline
