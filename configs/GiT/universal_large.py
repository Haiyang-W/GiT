...
model = dict(
    ...
    bert_embed=dict(type='bert-base', hidden_size=1024, pretrain_path='./bert_embed_large.pt'),
...
train_dataloader = dict(
    ...
    sampler=dict(type='GroupMultiSourceNonMixedSampler', batch_size=2,
                source_ratio=[
...
auto_scale_lr = dict(base_batch_size=24,enable=True)
