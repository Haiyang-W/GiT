...
def parse_args():
    ...
    parser.add_argument('data_path', help='path of the zip file')
...
def main():
    ...
    tmp_dir = osp.dirname(args.data_path)
    # with tempfile.TemporaryDirectory(dir=args.tmp_dir) as tmp_dir:
    print('Extracting training.zip...')
    zip_file = zipfile.ZipFile(args.data_path)
    zip_file.extractall(tmp_dir)
    tmp_dir = osp.join(tmp_dir,'DRIVE')
